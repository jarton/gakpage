...
/***/ function(module, exports, __webpack_require__) {
	...
	function addClickListerns() {
		(0, _jquery2.default)('.vidThumb').on('click', function (event) {
			...
			var vidWidth = Math.floor((0, _jquery2.default)(window).width() * 0.8);
			if (vidWidth >= 1200) {
				vidWidth = 1100;
			}
			var vidHeight = Math.floor(vidWidth / 2);
			//show new video
			var html = '<iframe src="https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2F338312802949307%2Fvideos%2Fvb.338312802949307%2F' + event.target.id + '%2F%3Ftype%3D2%26theater&width=' + vidWidth + '&show_text=false&height=' + vidHeight + '&appId" width="' + vidWidth + '" height="' + vidHeight + '" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>';
			console.log(html);
...
/***/ function(module, exports) {
	...
	module.exports = [
		...
		{
			"name": "NM Lag 2014",
			"faceID": "687474414699809"
		},
		{
			"name": "Julestevne 2013",
			"faceID": "502457746534811"
		}
	];
	...
	exports.default = {
		loadNews: function loadVids() {
			_news2.default.forEach(function (story) {
				...
				(0, _jquery2.default)('#' + story.id).load(story.html);
			});
		}
	};
	...
	module.exports = [
		{
			...
			"date": "28.06.2016",
			"header": "Regionsamling Sommer",
			"html": "data/news/sommersamling.html",
			"id": "sommersamling2016"
		},
		{
			"author": "Tor Kristoffer Kletthagen",
			"date": "31.01.2016",
			"header": "Regionsamling vinter",
			"id": "vintersamling2016",
			"html": "data/news/regsamling_vinter_2016.html"
		},
		{
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "<div class='page-header'>\n\t<h1>Informasjon <small> trening, stevner og vedtekter </small></h1>\n</div>\n\n<div class='row'>\n\t<div class='col-md-6'>\n\t\t<h3>Tren med oss </h3>\n\t\t<p>\t\tTa med treningsklær, \n\t\tjoggesko/crossfitsko/vektløftersko og drikkeflaske!\n\t\t</p>\n\n\t\t<p>\tVi har dame- og herregarderobe. </p>\n\n\t\t<p> Håper vi sees på trening! </p>\n\n\t\t<img class='img-responsive' src='" + __webpack_require__(34) + "'></img>\n\n\t\t<hr></hr>\n\n\t\t<h3> Dokumenter </h3>\n\t\t<hr></hr>\n\t\t<a href='docs/merkekrav2016.pdf'>Merkekrav fra NVF</a>\n\t\t<hr></hr>\n\t\t<a href='docs/retningslinjer_gak.pdf'>Retningslinger for medlemmer</a>\n\t\t<hr></hr>\n\t\t<a href='docs/kriterier_adgangskort_gak.pdf'>Kriterier for adgangskort</a>\n\t\t<hr></hr>\n\n\t</div>\n\t<div class='col-md-6'>\n\t\t<div class='panel panel-default'>\n\t\t\t<div class='panel-heading'>\n\t\t\t\t<h3 class='panel-title'><strong> Her finner du oss </strong> </h3>\n\t\t\t</div>\n\t\t\t<div class='panel-body'>\n\t\t\t\t<p>Gjøvik Stadion, Oscar Nissens Gate 2, 2821 Gjøvik</p>\n\t\t\t\t<div class='google-maps'>\n\t\t\t\t<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1946.4134722714152!2d10.680033608845022!3d60.80095306365439!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4641da1bd58d5549%3A0x1b525b1a35a37601!2sOscar+Nissens+gate+2%2C+2821+Gj%C3%B8vik!5e0!3m2!1sno!2sno!4v1468631342036\" width=\"520\" height=\"450\" frameborder=\"0\" style=\"border:0\" allowfullscreen></iframe>\n\t\t\t\t</div>\n\t\t\t\t<br></br>\n\t\t\t\t<img src='" + __webpack_require__(35) + "' class='img-responsive'></img>\n\t\t\t</div>\n\t\t</div>\n\n\n\t\t<div class='panel panel-default'>\n\t\t\t<div class='panel-heading'>\n\t\t\t\t<h3 class='panel-title'><strong> Medlemspriser </strong></h3>\n\t\t\t\t</div>\n\t\t\t<div class='panel-body'>\n\t\t\t\t<table class='table table-striped'>\n\t\t\t\t\t<tr> \n\t\t\t\t\t\t<td> Ungdom </td>\n\t\t\t\t\t\t<td> 500 kr/år</td>\n\t\t\t\t\t</tr>\n\t\t\t\t\t<tr> \n\t\t\t\t\t\t<td> Junior </td>\n\t\t\t\t\t\t<td> 1500 kr/år</td>\n\t\t\t\t\t</tr>\n\t\t\t\t\t<tr> \n\t\t\t\t\t\t<td> Student </td>\n\t\t\t\t\t\t<td> 1500 kr/år</td>\n\t\t\t\t\t</tr>\n\t\t\t\t\t<tr> \n\t\t\t\t\t\t<td> Senior </td>\n\t\t\t\t\t\t<td> 2000 kr/år</td>\n\t\t\t\t\t</tr>\n\t\t\t\t</table>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n";

/***/ },
/* 34 */
/***/ function(module, exports) {

	module.exports = "data:image/jpeg;base64,"
